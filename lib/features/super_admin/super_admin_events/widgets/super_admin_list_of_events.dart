...
class SuperAdminListOfEvents extends StatefulWidget {
  const SuperAdminListOfEvents({super.key});

  @override
  State<SuperAdminListOfEvents> createState() => _SuperAdminListOfEventsState();
}

class _SuperAdminListOfEventsState extends State<SuperAdminListOfEvents> {
              ...
              return Padding(
                ...
                child: EventCard(
                  ...
                  onTap: () {
                    ...
                    // Navigate to appropriate event details route based on user role
